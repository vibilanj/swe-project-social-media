              ...
              {dropdownOpen && (
                <div className="absolute -right-6 bg-white shadow-md shadow-gray-300 p-3 rounded-sm border border-gray-100 w-52 z-10">
                  <button onClick={toggleSave} className="w-full -my-2">
                    <span className="flex gap-3 py-2 my-2 hover:bg-socialGreen hover:text-white -mx-4 px-4 rounded-md transition-all hover:scale-110 hover:shadow-md shadow-gray-300">
                      {isSaved && (
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                  ...
                  <a href="" className="flex gap-3 py-2 my-2 hover:bg-socialGreen hover:text-white -mx-4 px-4 rounded-md transition-all hover:scale-110 hover:shadow-md shadow-gray-300">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
      ...
      <div>
        ...
        {photos.length > 0 && (
          <div className="grid md:grid-cols-2 gap-4">
            {photos.map(photo => (
              <div key={photo} className="rounded-md overflow-hidden aspect-square">
