...
export default function NavigationCard() {
  ...
  const activeElementClasses = 'text-sm md:text-md flex md:gap-1 md:gap-3 py-3 my-1 bg-socialGreen text-white md:-mx-8 px-6 md:px-8 rounded-md shadow-md shadow-gray-300';
  const nonActiveElementClasses = 'text-sm md:text-md flex md:gap-1 md:gap-3 py-2 my-2 hover:bg-emerald-500 hover:bg-opacity-20 md:-mx-4 px-6 md:px-4 rounded-md transition-all hover:scale-110 hover:shadow-md shadow-gray-300';
  ...
  return (
    <Card noPadding={true}>
      <div className="px-4 py-2 flex justify-between md:block shadow-md shadow-gray-500 md:shadow-none">
        <h1 className="text-emerald-800 mb-3 hidden md:block text-xl">Ripple</h1>
